  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="fs-4 Sidetop">Shopsense</span>
      </a>
      <hr />
      <ul className="nav nav-pills flex-column mb-auto">
        ...
        <li   onClick={() => {
            setselectedTab("ProfitPrediction");
          }}>
          <a href="#" className= {`nav-link  text-white ${
              selectedTab === "ProfitPrediction" && "active"
            }`}>
            <svg className="bi pe-none me-2" width="16" height="16">
        ...
        <li   onClick={() => {
          ...
          <a href="#" className= {`nav-link  text-white ${
              selectedTab === "Segmentation" && "active"
            }`}>
            <svg className="bi pe-none me-2" width="16" height="16">
        ...
        <li   onClick={() => {
            setselectedTab("MaxProfit");
          }}  >
          <a href="#" className= {`nav-link  text-white ${
              selectedTab === "MaxProfit" && "active"
            }`}>
            <svg className="bi pe-none me-2" width="16" height="16">
